...
public class DBHelper extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase sqLiteDatabase) {
        ...
        sqLiteDatabase.execSQL(String.format("CREATE TABLE IF NOT EXISTS %s(id_config integer primary key autoincrement, id_user INTEGER, app_name VARCHAR(255), app_intent_uri VARCHAR(255), app_image VARCHAR(255),active INTEGER ,date_create TIMESTAMP DEFAULT CURRENT_TIMESTAMP, status_ws INTEGER)", USER_CONFIG_LAUNCHER));
